...
- **R3 — Dependientes = comerciales puros.** Socios / distribuidores / cajeros DEPENDIENTES **no tocan plata** (no aprueban dep/retiros, no cargan/quitan fichas, no corrigen). Solo publicidad + gestionar su equipo + cobrar comisión %. **Toda la plata central la manejan solo el admin + sus empleados.**
