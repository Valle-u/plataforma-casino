 ...
 *   - v0.12: tweak fino — 1 mandolin→1 emerald en reels 1 y 5
 *           (espejo). Mandolin paga 40× vs emerald 8× → bajamos ~1pp.
 *
 * Composición v0.12 por símbolo:
 *
...
export const REEL_STRIPS: ReadonlyArray<readonly SymbolCode[]> = [
  // Reel 1 — 40 stops: joker 5, crown 9, mandolin 4, boots 4, gemas 18
  [
  ...
  // Reel 2 — 40 stops: joker 8, crown 8, mandolin 4, boots 4, gemas 16
  [
  ...
  // Reel 3 — 40 stops: joker 8, crown 9, mandolin 3, boots 4, gemas 16
  [
  ...
  // Reel 4 — 40 stops: igual config que reel 2 (espejo)
  [
  ...
  // Reel 5 — 40 stops: igual config que reel 1 (espejo)
  [
    'joker', 'crown', 'ruby', 'mandolin', 'crown', 'sapphire', 'diamond_pink', 'boots',
    'joker', 'crown', 'emerald', 'mandolin', 'crown', 'ruby', 'sapphire', 'joker',
    'crown', 'diamond_pink', 'emerald', 'boots', 'crown', 'emerald', 'joker', 'ruby',
