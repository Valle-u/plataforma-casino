...
describe('BankTransactionsController — edit/delete (E2E)', () => {
  ...
  // mutable y quién subió la transferencia no. El test subía la transferencia
  ...
  //
  // Nunca había llegado a esa aserción: moría antes, al crear la transferencia,
  // porque el fixture no mandaba los datos que exige la validación de
  // trazabilidad. Al completarlo, llegó y falló.
  //
