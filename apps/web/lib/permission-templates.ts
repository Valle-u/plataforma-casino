...
export const PERMISSION_TEMPLATES: readonly PermissionTemplate[] = [
  ...
  {
    id: 'empleado-fichas-cargador',
    nombre: 'Empleado de Fichas (Cargador de Caja)',
    descripcion:
      'Cargador de caja: carga y descarga fichas a jugadores de la red del admin, hace correcciones contra el cupo mensual (docs/19) y otorga bonos manuales puntuales.',
    rol: 'empleado',
    cupoMensualDefault: '0',
    caveat:
    ...
    permisos: [
      ...
      { code: 'bonuses.grant_manual_admin_network', categoria: 'bonos', requerido: false },
      { code: 'bonuses.cancel_admin_network', categoria: 'bonos', requerido: false },
  ...
  {
    id: 'empleado-bonos-promos',
    nombre: 'Empleado de Bonos y Promociones',
    descripcion:
      'Gestiona la operatoria promocional: crea y edita definiciones de bono, otorga bonos manuales, cancela bonos activos con motivo y consulta wallets para chequear elegibilidad.',
    rol: 'empleado',
    cupoMensualDefault: '0',
    permisos: [
      { code: 'bonuses.view', categoria: 'bonos', requerido: true },
