                  ...
                  >
                    ...
                    <TD>
                      <div className="flex items-center gap-2">
                        ...
                        {n.status === 'failed' && (
                          <AlertTriangle className="size-3 text-[var(--color-accent)]" />
                        )}
                      </div>
                    </TD>
                    <TD>
    ...
    >
      {notification && (
        <div className="flex flex-col gap-5">
          ...
          {notification.error && (
            <Field label="Error">
              <pre className="text-[11px] font-mono leading-relaxed bg-[var(--color-accent-subtle)] border border-[var(--color-accent-border)] p-3 whitespace-pre-wrap break-words max-h-[160px] overflow-y-auto text-[var(--color-accent)]">
                {notification.error}
              </pre>
            </Field>
          )}
